    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card movie-card">
                <div class="card-body">
                    <a href="{{ route('books.show2', $book->id) }}" class="movie-title">
                        {{ $book->titolo }}
                    </a>
                    ...
                    <div class="d-flex justify-content-between">
                     <!-- <a href="{{ route('books.cart', $book->id) }}" class="btn btn-outline-primary btn-edit">Cart</a>   -->     
                     <button class="btn btn-outline-primary btn-edit">cart</button>                 
                    </div> 
